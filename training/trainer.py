...
def do_train(params: TrainingParams):
    ...
    if params.scheduler is None:
        ...
        if params.scheduler == 'CosineAnnealingLR':
            ...
            gamma = np.exp(np.log(params.min_lr / params.lr) / params.epochs)
    ...
    # wandb.init(project='Place Recognition', config=params_dict)
    wandb.init(project='MinkLocExps', config=params_dict)

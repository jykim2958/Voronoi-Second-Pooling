...
if __name__ == '__main__':
    ...
    parser.add_argument('--cloud_folder', type = str, default = 'Clouds_segmented', help = 'Name of folder containing point cloud frames')

    parser.add_argument('--eval_thresh', type = float, default = 3, help  = 'Threshold for correct retrieval during eval') # 5
